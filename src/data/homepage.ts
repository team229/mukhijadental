...
export const allServices: ServiceItem[] = [
  ...
  { title: "Teeth Cleaning", description: "Professional scaling, polishing, and ultrasonic teeth cleaning.", href: "/services/teeth-cleaning/", image: "/images/services/teeth-cleaning-treatment-sonipat.jpg?v=1", alt: "Teeth cleaning — ultrasonic scaling procedure" },
  ...
  { title: "Maxillofacial Surgery", description: "Wisdom tooth removal and complex oral surgical procedures.", href: "/services/maxillofacial-surgery/", image: "/images/services/maxillofacial-surgery-treatment-sonipat.jpg?v=1", alt: "Maxillofacial surgery — oral surgical procedure" },
